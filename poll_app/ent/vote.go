...
func (e VoteEdges) OptionsOrErr() ([]*PollOption, error) {
	if e.loadedTypes[1] {
...
// QueryOptions queries the "options" edge of the Vote entity.
func (v *Vote) QueryOptions() *PollOptionQuery {
	return NewVoteClient(v.config).QueryOptions(v)
}
